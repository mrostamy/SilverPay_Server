package com.mydomain.silverpay.controller.app.V1.panel.common;
...
import com.mydomain.silverpay.data.dto.app.panel.accountant.AccountantDashboardDto;
import com.mydomain.silverpay.data.dto.app.panel.upload.users.UserBlogInfoDto;
...
//        res.setFactors10Days();
        ...
        res.setLastTenFactors(factorRepository.findTop10ByUserId(user_id));//order by date created
        res.setLastTenEntries(entryRepository.findTop10ByUserId(user_id));//order by date created
