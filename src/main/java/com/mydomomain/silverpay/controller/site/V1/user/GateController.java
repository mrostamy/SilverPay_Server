...
import com.mydomomain.silverpay.configuration.model_mapper.GateMapper;
import com.mydomomain.silverpay.configuration.model_mapper.WalletMapper;
import com.mydomomain.silverpay.dto.site.panel.gate.ActiveDirectGateDto;
...
import com.mydomomain.silverpay.dto.site.panel.gate.GateWalletsReturnDto;
import com.mydomomain.silverpay.dto.site.panel.upload.FileUploadedDto;
import com.mydomomain.silverpay.dto.site.panel.users.GatesWalletsReturnDto;
    ...
    public ResponseEntity<?> activeDirectGate(
        ...
        if (directGateDto.isDirect()) {
            if (walletService.checkInventory(20000, directGateDto.getWallet_id())) {
                ...
                ReturnMessage decResult = walletService.decrease(20000, directGateDto.getWallet_id());
                ...
                if (decResult.isStatus()) {
                    ...
                    if (updateResult != null)
                        ...
                        ReturnMessage incResult = walletService.increase(20000, directGateDto.getWallet_id());
